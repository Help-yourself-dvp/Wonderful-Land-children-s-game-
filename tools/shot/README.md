...
> ⏱ Полный прогон занимает ~25–35 минут. Запуск — только по согласованию с владельцем;
> быстрые части (games/ui, screens) допустимы в конце спринта без отдельного вопроса.
